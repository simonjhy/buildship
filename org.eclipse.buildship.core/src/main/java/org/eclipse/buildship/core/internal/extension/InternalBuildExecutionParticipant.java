...
public final class InternalBuildExecutionParticipant implements BuildExecutionParticipant {
    ...
    @Override
    public void preAction(File projectDir, String task, IProgressMonitor monitor) {
        this.buildExecutionParticipant.preAction(projectDir, task, monitor);
    }

    @Override
    public void postAction(File projectDir, String task, IProgressMonitor monitor) {
        this.buildExecutionParticipant.postAction(projectDir, task, monitor);
    }
